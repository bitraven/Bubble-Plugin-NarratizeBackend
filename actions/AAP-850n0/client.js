function(properties, context) {
    ...
    function generateJSONFor_BasicQA(qaCount, questionList, answerList) {
        var result = {}
    ...
    function generateJSONFor_ArticleFromScratch(qaCount, questionList, answerList){
        var result = {}
    ...
    function generateJSONFor_WFFTRC(qaCount, questionList, answerList){
        var result = {}
    ...
    function generateJSONFor_CaseStudy(qaCount, questionList, answerList) {
        var result = {}
    ...
    function generateJSONFor_WhitePaper(qaCount, questionList, answerList) {
      	var result = {}
    ...
    if (BASIC_QA_TRANSFORM_LIST.includes(transformKey) ) {
      	templateResult = generateJSONFor_BasicQA(gQACount, gQuestionList, gAnswerList)
    }
    else if (TRANSFORMATION_TRANSFORM_LIST.includes(transformKey)) {
      	templateResult = generateJSONFor_Transformation(transformKey, gContent)
    } 
    else if (transformKey == 'WhitePaper') {
      	templateResult = generateJSONFor_WhitePaper(gQACount, gQuestionList, gAnswerList)
    } 
    else if (transformKey == 'ArticleFromScratch') {
        templateResult = generateJSONFor_ArticleFromScratch(gQACount, gQuestionList, gAnswerList)
    } 
    else if (transformKey == 'CaseStudy') {
      	templateResult = generateJSONFor_CaseStudy(gQACount, gQuestionList, gAnswerList)
    } 
    else if (transformKey === 'WFF-TRC Concept Note') {
      	templateResult = generateJSONFor_WFFTRC(gQACount, gQuestionList, gAnswerList)
    }
